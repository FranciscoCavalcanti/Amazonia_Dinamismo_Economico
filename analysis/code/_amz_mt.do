...
//	Por setores atividade econônmica (CNAE)
* run do file
do "$code_dir\_sub_code\_amz_mt_rkng_n_ocu_por_atividade_2digitos.do"

//	Por setores tipo de ocupação (COD)
* run do file
do "$code_dir\_sub_code\_amz_mt_rkng_n_ocu_por_ocupacao_2digitos.do"
...
//	Por setores atividade econônmica (CNAE)
* run do file
do "$code_dir\_sub_code\_amz_mt_rkng_v_massa_por_atividade_2digitos.do"

//	Por setores tipo de ocupação (COD)
* run do file
do "$code_dir\_sub_code\_amz_mt_rkng_v_massa_por_ocupacao_2digitos.do"