...
* call data 
use "$input_dir\_amz_manaus_numero_ocupados_por_ocupacao_2digitos.dta", clear
...
#delim ;    
esttab matrix(A, fmt("%16,0fc" "%16,1fc" "%16,1fc" "%16,0fc" "%16,0fc" "%16,1fc" "%16,1fc")) using "$output_dir\amzmanauscod2dig.tex", 
	replace 
    prehead(
		"\begin{table}[H]"
		"\centering"
		"\label{amzmanauscod2dig}"
		"\scalebox{0.56}{"
