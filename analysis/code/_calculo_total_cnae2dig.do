...
collapse (mean) renda_media2012 [aweight=n_ocu_cnae2012]
...
collapse (mean) renda_media2019 [aweight=n_ocu_cnae2019]
...
* variacao absoluta
foreach var in n_ocu_cnae n_ocu_cnae_formal n_ocu_cnae_privado n_ocu_cnae_publico {
sort nova_agregacao  
...
* variacao relativa
foreach var in renda_media n_ocu_cnae n_ocu_cnae_formal n_ocu_cnae_privado n_ocu_cnae_publico {
sort nova_agregacao 
...
sort nova_agregacao 
by nova_agregacao, sort: gen ops1 = (n_ocu_cnae_formal2019/n_ocu_cnae2019)*100
by nova_agregacao, sort: egen p_formal = mean(ops1) 
cap drop ops1

* percentual de privado
by nova_agregacao, sort: gen ops1 = (n_ocu_cnae_privado2019/n_ocu_cnae2019)*100
...
recode nova_agregacao (. = 35) 
label define nova_agregacao 35 "Total", add
