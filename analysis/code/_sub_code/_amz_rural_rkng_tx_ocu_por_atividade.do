...
* local notes
local ttitle "Taxas de crescimento de ocupações por grupamentos de atividade entre 2012 e 2019"
local tnotes "Fonte: com base nos dados da PNAD Contínua, IBGE"

#delim ;    
esttab matrix(A, fmt(%16,2fc)) using "$output_dir\amzruralrkngtxocuporatividade.tex", 
	replace 
