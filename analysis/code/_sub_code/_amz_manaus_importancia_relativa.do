...
set scheme amz2030  
	...
	graph twoway line n_ocu_str1 n_ocu_str2 n_ocu_str3 n_ocu_str4 n_ocu_str5 n_ocu_str6 n_ocu_str7 n_ocu_str8 n_ocu_str9 n_ocu_str10 n_ocu_str11 n_ocu_str12 trim  /*
		...
		*/  saving("$tmp_dir\_amz_manaus_importancia_relativa", replace) 	
		
		
* save graph 
graph use "$tmp_dir\_amz_manaus_importancia_relativa.gph"
erase "$tmp_dir\_amz_manaus_importancia_relativa.gph"
graph export "$output_dir\_amz_manaus_importancia_relativa.png", replace		