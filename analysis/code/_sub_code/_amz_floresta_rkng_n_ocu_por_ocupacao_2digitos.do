...
* call data 
use "$input_dir\_amz_floresta_numero_ocupados_por_ocupacao_2digitos.dta", clear
...
#delim ;    
esttab matrix(A, fmt(%16,0fc)) using "$output_dir\amzflorestarkngnocuporcod2dig.tex", 
	replace 
	collabels("Variação")
    prehead(
        "\begin{table}[H]"
        "\centering"
		"\label{amzflorestarkngnocuporcod2dig}"
		"\scalebox{0.70}{"
