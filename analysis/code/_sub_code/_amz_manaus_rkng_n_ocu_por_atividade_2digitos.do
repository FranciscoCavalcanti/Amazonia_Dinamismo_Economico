...
* call data 
use "$input_dir\_amz_manaus_numero_ocupados_por_atividade_2digitos.dta", clear
...
#delim ;    
esttab matrix(A, fmt(%16,0fc)) using "$output_dir\amzmanausrkngnocuporcnae2dig.tex", 
	replace 
	collabels("Variação")
    prehead(
        "\begin{table}[H]"
        "\centering"
		"\label{amzmanausrkngnocuporcnae2dig}"
		"\scalebox{0.70}{"
