******************************************************
**	 Taxas de crescimento de rendimentos médio por grupamentos de atividade	**
******************************************************

* call data 
use "$input_dir\_amz_rural_numero_ocupados_por_atividade.dta", clear
...
by cod_atividade, sort: gen tx_crescimento = (renda_media[_n]/renda_media[_n-1])*100 -100
...
* local notes
local ttitle "Taxas de crescimento de rendimentos médio por grupamentos de atividade entre 2012 e 2019"
local tnotes "Fonte: com base nos dados da PNAD Contínua, IBGE"

#delim ;    
esttab matrix(A, fmt(%16,2fc)) using "$output_dir\amzruralrkngtxrendaporatividade.tex", 
	replace 
	...
	nomtitle
        ...
        35021 "Produção e distribuição de combustíveis gasosos por redes rurals"
