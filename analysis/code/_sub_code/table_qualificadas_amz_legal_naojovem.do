...
#delim ;    
esttab matrix(A, fmt("%16,0fc" "%16,1fc" "%16,1fc" "%16,0fc" "%16,0fc" "%16,1fc" "%16,1fc")) using "$output_dir\tablequalificadasamzlegalnaojovem.tex", 
	replace 
    prehead(
		"\begin{table}[H]"
		"\centering"
		"\label{tablequalificadasamzlegalnaojovem}"
		"\scalebox{0.56}{"
