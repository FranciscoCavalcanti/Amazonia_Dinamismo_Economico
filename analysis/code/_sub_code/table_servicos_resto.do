...
* call data 
use "$input_dir\_amz_resto_numero_ocupados_por_ocupacao_2digitos.dta", clear
...
#delim ;    
esttab matrix(A, fmt("%16,0fc" "%16,1fc" "%16,1fc" "%16,0fc" "%16,0fc" "%16,1fc" "%16,1fc")) using "$output_dir\tableservicosamzresto.tex", 
	replace 
    prehead(
		"\begin{table}[H]"
		"\centering"
		"\label{tableservicosamzresto}"
		"\scalebox{0.56}{"
