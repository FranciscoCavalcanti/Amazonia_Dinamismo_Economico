...
* call data 
use "$input_dir\_amz_ac_numero_ocupados_por_atividade_2digitos.dta", clear
...
#delim ;    
esttab matrix(A, fmt(%16,0fc)) using "$output_dir\amzacrkngnocuporcnae2dig.tex", 
	replace 
	collabels("Variação")
    prehead(
        "\begin{table}[H]"
        "\centering"
		"\label{amzacrkngnocuporcnae2dig}"
		"\scalebox{0.70}{"
