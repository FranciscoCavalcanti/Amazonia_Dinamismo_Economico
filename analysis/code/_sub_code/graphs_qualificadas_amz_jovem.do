...
graph twoway line normalized_n_ocu trim  if titulo == "Cientistas e engenheiros", lwidth(thick) || /*
		...
		*/ 	xlabel(#9, angle(45)) 	/*
		*/  saving("$tmp_dir\_graph_qualificadas_amz_jovem_desagregado", replace) 
				
graph use "$tmp_dir\_graph_qualificadas_amz_jovem_desagregado.gph"		
erase "$tmp_dir\_graph_qualificadas_amz_jovem_desagregado.gph"
graph export "$output_dir\_graph_qualificadas_amz_jovem_desagregado.png", replace					
