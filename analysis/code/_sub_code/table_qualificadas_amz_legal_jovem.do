...
#delim ;    
esttab matrix(A, fmt("%16,0fc" "%16,1fc" "%16,1fc" "%16,0fc" "%16,0fc" "%16,1fc" "%16,1fc")) using "$output_dir\tablequalificadasamzlegaljovem.tex", 
	replace 
    prehead(
		"\begin{table}[H]"
		"\centering"
		"\label{tablequalificadasamzlegaljovem}"
		"\scalebox{0.56}{"
