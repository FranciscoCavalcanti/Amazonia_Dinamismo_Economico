...
* call data 
use "$input_dir\_amz_rural_numero_ocupados_por_ocupacao_2digitos.dta", clear
...
graph twoway line normalized_n_ocu trim , lwidth(thick)	/*
		...
		*/ 	xlabel(#8, angle(45)) 	/*
		*/  saving("$tmp_dir\_graph_qualificadas_amz_rural", replace) 
		
graph use "$tmp_dir\_graph_qualificadas_amz_rural.gph"		
erase "$tmp_dir\_graph_qualificadas_amz_rural.gph"
graph export "$output_dir\_graph_qualificadas_amz_rural.png", replace	
...
graph use "$tmp_dir\_graph_qualificadas_amz_rural_desagregado.gph"		
erase "$tmp_dir\_graph_qualificadas_amz_rural_desagregado.gph"
graph export "$output_dir\_graph_qualificadas_amz_rural_desagregado.png", replace					
