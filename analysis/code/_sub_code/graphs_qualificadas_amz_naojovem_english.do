...
* call data 
use "$input_dir\_amz_naojovem_numero_ocupados_por_ocupacao_2digitos.dta", clear
...
graph twoway line normalized_n_ocu trim , lwidth(thick)	/*
		...
		*/ 	xlabel(#8, angle(45)) 	/*
		*/  saving("$tmp_dir\_graph_qualificadas_amz_naojovem_english", replace) 
		
graph use "$tmp_dir\_graph_qualificadas_amz_naojovem_english.gph"		
erase "$tmp_dir\_graph_qualificadas_amz_naojovem_english.gph"
graph export "$output_dir\_graph_qualificadas_amz_naojovem_english.png", replace	
...
graph twoway line normalized_n_ocu trim  if titulo == "Cientistas e engenheiros", lwidth(thick) || /*
		...
		*/ 	xlabel(#9, angle(45)) 	/*
		*/  saving("$tmp_dir\_graph_qualificadas_amz_naojovem_desagregado_english", replace) 
				
graph use "$tmp_dir\_graph_qualificadas_amz_naojovem_desagregado_english.gph"		
erase "$tmp_dir\_graph_qualificadas_amz_naojovem_desagregado_english.gph"
graph export "$output_dir\_graph_qualificadas_amz_naojovem_desagregado_english.png", replace					
