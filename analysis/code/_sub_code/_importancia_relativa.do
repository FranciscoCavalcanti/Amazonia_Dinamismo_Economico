...
set scheme amz2030  
	...
	graph twoway line n_ocu_str1 n_ocu_str2 n_ocu_str3 n_ocu_str4 n_ocu_str5 n_ocu_str6 n_ocu_str7 n_ocu_str8 trim  /*
		...
		*/ 	legend(on cols(4) label(1 "Agropecuária") label(2 "Indústria geral")  label(3 "Construção") label(4 "Comércio") label(5 "Transporte") label(6 "Alimentação") label(7 "Outros serviços") label(8 "Administração pública") size(small) forcesize symysize(2pt) symxsize(2pt) ) 	/*
