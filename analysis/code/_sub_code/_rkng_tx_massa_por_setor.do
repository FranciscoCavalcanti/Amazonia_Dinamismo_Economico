******************************************************
**	 Taxas de crescimento de massa salarial por setor  **
******************************************************
...
* local notes
local ttitle "Taxas de crescimento da massa de rendimentos por setores econômicos entre 2012 e 2019"
local tnotes "Fonte: com base nos dados da PNAD Contínua, IBGE"

#delim ;    
esttab matrix(A, fmt(%16,2fc)) using "$output_dir\rkngtxmassaporsetor.tex", 
    replace 
