...
* call data 
use "$input_dir\_amz_floresta_numero_ocupados_por_atividade_2digitos.dta", clear
...
#delim ;    
esttab matrix(A, fmt(%16,0fc)) using "$output_dir\amzflorestarkngnocuporcnae2dig.tex", 
	replace 
	collabels("Variação")
    prehead(
        "\begin{table}[H]"
        "\centering"
		"\label{amzflorestarkngnocuporcnae2dig}"
		"\scalebox{0.70}{"
