...
by cod_ocupacao, sort: gen tx_crescimento = (massa_salarial[_n]/massa_salarial[_n-1])*100 -100
...
* local notes
local ttitle "Taxas de crescimento de massa de rendimentos por tipo de ocupação entre 2012 e 2019"
local tnotes "Fonte: com base nos dados da PNAD Contínua, IBGE"

#delim ;    
esttab matrix(A, fmt(%16,2fc)) using "$output_dir\amzmanausrkngtxmassaporocupacao.tex", 
	replace 
	collabels("Tx. Cresc. (\%)")
    prehead(
        "\begin{table}[H]"
