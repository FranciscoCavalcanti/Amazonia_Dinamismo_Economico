...
graph use "$tmp_dir\_graph_setorpublico.gph"		
erase "$tmp_dir\_graph_setorpublico.gph"
graph export "$output_dir\_graph_setorpublico.png", replace	
...
graph use "$tmp_dir\_graph_setorpublico_desagregado.gph"		
erase "$tmp_dir\_graph_setorpublico_desagregado.gph"
graph export "$output_dir\_graph_setorpublico_desagregado.png", replace					
