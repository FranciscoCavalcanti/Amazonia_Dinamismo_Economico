...
gen titulo = "Total das maiores ocupações"
tempfile base_total
...
#delim ;    
esttab matrix(A, fmt("%16,0fc" "%16,1fc" "%16,1fc" "%16,0fc" "%16,0fc" "%16,1fc" "%16,1fc")) using "$output_dir\amztablevendedores.tex", 
	replace 
    prehead(
		"\begin{table}[H]"
		"\centering"
		"\label{amztablevendedores}"
		"\scalebox{0.56}{"
