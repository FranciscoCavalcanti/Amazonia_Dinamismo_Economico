...
* call data 
use "$input_dir\_amz_mt_numero_ocupados_por_ocupacao_2digitos.dta", clear
gen group = "Mato Grosso" 
...
#delim ;    
esttab matrix(A, fmt("%16,0fc" "%16,1fc" "%16,1fc" "%16,0fc" "%16,0fc" "%16,1fc" "%16,1fc")) using "$output_dir\amztableagropecuariamt.tex", 
	replace 
    prehead(
		"\begin{table}[H]"
		"\centering"
		"\label{amztableagropecuariamt}"
		"\scalebox{0.56}{"
