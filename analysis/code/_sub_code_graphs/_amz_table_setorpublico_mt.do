...
#delim ;    
esttab matrix(A, fmt("%16,0fc" "%16,1fc" "%16,1fc" "%16,0fc" "%16,0fc" "%16,1fc" "%16,1fc")) using "$output_dir\amztablesetorpublicomt.tex", 
	replace 
    prehead(
		"\begin{table}[H]"
		"\centering"
		"\label{amztablesetorpublicomt}"
		"\scalebox{0.56}{"
	...
	coeflabels(   /* run the follwing code:  label list nova_agregacao */
		   ...
		   30 "Total depêndecia do setor público"	
		  )
    ;
#delim cr