...
\begin{itemize}
\item{Por atividade econômica: \hyperlink{tablendeocupadosporsetor}{\beamerbutton{clique aqui}}}
\end{itemize}


\end{frame}

\section{Por atividade econômica}

\begin{frame}
\textit{\hyperlink{indice_principal}{\beamerbutton{Voltar}}}
\input{./../analysis/output/tablendeocupadosporsetor}
\end{frame}
