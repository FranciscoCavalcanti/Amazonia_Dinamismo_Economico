...
drop tempvar*
gen cod_cod2dig = substr(V4010,1,2)
...
by Ano Trimestre cod_cod2dig, sort: egen iten2 = total(iten1)
...
by Ano Trimestre cod_cod2dig, sort: egen total_renda_ocupado = total(iten1)
...
* colapse
collapse (firstnm) `colvar' , by(Ano Trimestre cod_cod2dig)
