...
compress
save "$output_dir\_amz_am_numero_ocupados_por_setor.dta", replace
...
* save in the output directory
compress
save "$output_dir\_amz_am_numero_ocupados_por_ocupacao.dta", replace
...
* save in the output directory
compress
save "$output_dir\_amz_am_numero_ocupados_por_atividade.dta", replace
