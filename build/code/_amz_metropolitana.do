...
******************************
**	Amazônia Legal Metropolitana	**
******************************

global area_geografica = "Amazônia Legal Metropolitana"
...
compress
save "$output_dir\_amz_metropolitana_numero_ocupados_por_ocupacao_2digitos.dta", replace
...
* save in the output directory
compress
save "$output_dir\_amz_metropolitana_numero_ocupados_por_atividade_2digitos.dta", replace