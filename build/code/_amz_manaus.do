...
compress
save "$output_dir\_amz_manaus_numero_ocupados_por_setor.dta", replace
...
* save in the output directory
compress
save "$output_dir\_amz_manaus_numero_ocupados_por_ocupacao.dta", replace
...
* save in the output directory
compress
save "$output_dir\_amz_manaus_numero_ocupados_por_atividade.dta", replace
...
* save in the output directory
compress
save "$output_dir\_amz_manaus_numero_ocupados_por_ocupacao_2digitos.dta", replace
...
* save in the output directory
compress
save "$output_dir\_amz_manaus_numero_ocupados_por_atividade_2digitos.dta", replace