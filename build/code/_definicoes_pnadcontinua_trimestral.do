...
if "$area_geografica" == "Amazônia Legal"   {
...
else if "$area_geografica" == "Amazônia Legal Metropolitana"   {
    keep if UF == 11 	/* 	Rondônia
	*/ 	| UF == 12 	/* Acre
	*/ 	| UF == 13 	/* Amazonas
	*/ 	| UF == 14 	/* Roraima
...
else if "$area_geografica" == "Acre"   {
    keep if UF == 12 	// Acre

	local area = "acre"
}
else if "$area_geografica" == "Amazonas"   {
    keep if UF == 13 	// Amazonas

	local area = "amazonas"
}
else if "$area_geografica" == "Amapa"   {
    keep if UF == 16 	// Amapa

	local area = "amapa"
}
else if "$area_geografica" == "Roraima"   {
    keep if UF == 14 	// Roraima

	local area = "roraima"
}
else if "$area_geografica" == "Rondonia"   {
    keep if UF == 11 	// Rondonia

	local area = "rondonia"
}
else if "$area_geografica" == "Tocantins"   {
	...
	*/ 	| (UF == 21 & V1023 == 4) 	// Maranhão & Resto da UF (Unidade da Federação, excluindo a região metropolitana e a RIDE)
	...
	gen tempvar1 = 0
	replace tempvar1 = 1 if VD4010 == 7 // Informação, comunicação e atividades financeiras, imobiliárias, profissionais e administrativas
	keep if tempvar1==1
	drop tempvar1
}	
else if "$area_geografica" == "Floresta e Agricultura"   {
    keep if UF == 11 	/* 	Rondônia
	*/ 	| UF == 12 	/* Acre
	*/ 	| UF == 13 	/* Amazonas
	*/ 	| UF == 14 	/* Roraima
	...
	*/ 	| (UF == 21 & V1023 == 4) 	// Maranhão & Resto da UF (Unidade da Federação, excluindo a região metropolitana e a RIDE)
	...
	gen tempvar1 = 0
	replace tempvar1 = 1 if VD4010 == 1 	// Agricultura
	keep if tempvar1==1
	drop tempvar1
}	
